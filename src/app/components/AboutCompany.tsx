export default function AboutCompany() {
  return (
    <section className="relative bg-[#F9F5F0] py-20 px-6 md:px-24 text-gray-800 overflow-hidden">
      ...
      <div className="absolute top-10 left-1/2 w-[400px] h-[400px] bg-gradient-radial from-amber-100/30 to-transparent rounded-full -translate-x-1/2 -translate-y-1/2 pointer-events-none blur-2xl"></div>

      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20 relative z-10">
        {/* Image */}
        <div className="relative w-full md:w-1/2 rounded-xl overflow-hidden shadow-xl border border-amber-100 flex items-center justify-center">
          <img
            src="/Hero_1.jpg"
            alt="About Company"
        ...
        <div className="w-full md:w-1/2 font-serif space-y-12">
          <div className="relative pl-6 border-l-4 border-amber-500">
            <div className="absolute -left-[9px] top-[6px] w-4 h-4 bg-amber-500 border-2 border-white rounded-full shadow-md"></div>
            ...
            <div className="space-y-10">
              {[
                ...
                <div key={i} className="relative pl-6 border-l-2 border-amber-400">
                  <div className="absolute -left-[9px] top-[6px] w-4 h-4 bg-amber-400 border-2 border-white rounded-full shadow-md"></div>
